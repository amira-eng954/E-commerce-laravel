                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" href="{{route('vendor.products.index')  }}" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                ...
                                <a class="nav-link" href="{{route('vendor.products.index')}}">All-product</a>
                                    <a class="nav-link" href="{{route('vendor.products.create')}}">Add-new-product</a>
                                </nav>
                            </div>
